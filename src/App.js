...
export default class App extends Component {
  pageSize = 5;                               // This means display the 5 news in one page 

  state = {
    progress: 0                      // set the initail progressbar is o               
  }

  setProgress = (progress) => {
    this.setState({ progress: progress })         // Function of the progress bar
  }
    ...
    return (
      <div>
        <BrowserRouter>
          ...
          <LoadingBar
            color='#f11946'
            height={3}                            // width of the loading bar
